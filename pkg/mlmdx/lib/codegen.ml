...
let components_lident name = Longident.Ldot (Longident.Ldot (Lident "Mlmdx", "Components"), name)
...
let rec inline ~origin ~file (i : Inline.t) : Parsetree.expression =
  ...
  | Inline.Emphasis (e, _) -> md_elt "em" ~children:[ inline ~origin ~file (Inline.Emphasis.inline e) ]
  | Inline.Strong_emphasis (e, _) ->
    md_elt "strong" ~children:[ inline ~origin ~file (Inline.Emphasis.inline e) ]
  | Inline.Code_span (cs, _) -> md_elt "code" ~children:[ jstring (Inline.Code_span.code cs) ]
...
and block ~origin ~file (b : Block.t) : Parsetree.expression =
  ...
  | Block.Paragraph (p, _) -> md_elt "p" ~children:[ inline ~origin ~file (Block.Paragraph.inline p) ]
