...
fn render_callout() {
    ...
    <article>
      ...
      <blockquote>
        <p>[!Tip]<br />tip with one space</p>
      </blockquote>
      <blockquote>
        <p>[!Tip]<br />tip with zero space</p>
      </blockquote>
      <blockquote>
        <p>[!Tip]<br />tip with 2 space -&gt; not a callout, just blockquote</p>
      </blockquote>
      <blockquote>
        <p>[!Tip] title<br />This is a tip with title</p>
      </blockquote>
      <blockquote><p>[!Tip] title</p></blockquote>
      <blockquote><p>This is a separate block quote</p></blockquote>
      <blockquote>
        <p>[!WARNING]<br />This is a warning</p>
      </blockquote>
      <blockquote>
        <p>[!LLM]<br />This is generated by LLM</p>
      </blockquote>
      <blockquote>
