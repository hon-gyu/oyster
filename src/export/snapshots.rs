...
fn render_callout() {
    ...
    <article>
      ...
      <callout data-callout="tip"
        ...
        ><callout-content></callout-content></callout
      ><callout data-callout="tip"
        ><callout-title
          ><callout-icon></callout-icon
          ><callout-title-text>Tip</callout-title-text></callout-title
            ...
            ><callout-content
              ><callout data-callout="example"
                ><callout-title
                  ...
                  ></callout-title
                ><callout-content></callout-content></callout></callout-content></callout></callout-content></callout
      ><callout data-callout="note"
        ><callout-title
          ><callout-icon></callout-icon
          ><callout-title-text>Note</callout-title-text></callout-title
        ><callout-content>
