...
mod tests {
    ...
    fn callout() {
        ...
        assert_snapshot!(&tree.root_node, @r#"
        Document [0..442]
          BlockQuote { standard_kind: None, callout_metadata: None } [0..17]
            Paragraph [2..17]
              Text(Borrowed("This is a note")) [2..16]
          BlockQuote { standard_kind: Some(Tip), callout_metadata: None } [18..48]
            Paragraph [29..48]
              Text(Borrowed("tip with one space")) [29..47]
          BlockQuote { standard_kind: Some(Tip), callout_metadata: None } [50..80]
            Paragraph [60..80]
              Text(Borrowed("tip with zero space")) [60..79]
          BlockQuote { standard_kind: None, callout_metadata: None } [82..145]
            Paragraph [85..145]
              Text(Borrowed("[")) [85..86]
          ...
          BlockQuote { standard_kind: None, callout_metadata: Some(CalloutMetadata { kind: Standard(Note), title: Some("title"), foldable: None }) } [147..189]
            Paragraph [149..189]
          ...
          BlockQuote { standard_kind: None, callout_metadata: Some(CalloutMetadata { kind: Standard(Note), title: Some("title"), foldable: None }) } [191..206]
            Paragraph [193..206]
              Text(Borrowed("[")) [193..194]
              Text(Borrowed("!Tip")) [194..198]
              Text(Borrowed("]")) [198..199]
              Text(Borrowed(" title")) [199..205]
          BlockQuote { standard_kind: None, callout_metadata: None } [207..240]
            Paragraph [209..240]
              Text(Borrowed("This is a separate block quote")) [209..239]
          BlockQuote { standard_kind: Some(Warning), callout_metadata: None } [241..274]
            Paragraph [256..274]
              Text(Borrowed("This is a warning")) [256..273]
          BlockQuote { standard_kind: None, callout_metadata: Some(CalloutMetadata { kind: Custom(Llm), title: None, foldable: None }) } [275..311]
            Paragraph [277..311]
          ...
          BlockQuote { standard_kind: None, callout_metadata: Some(CalloutMetadata { kind: Obsidian(Question), title: Some("Can callouts be nested?"), foldable: None }) } [313..442]
            Paragraph [315..351]
              Text(Borrowed("[")) [315..316]
              Text(Borrowed("!question")) [316..325]
              Text(Borrowed("]")) [325..326]
              Text(Borrowed(" Can callouts be nested?")) [326..350]
            BlockQuote { standard_kind: None, callout_metadata: Some(CalloutMetadata { kind: Obsidian(Todo), title: Some("Yes!, they can."), foldable: None }) } [353..442]
              Paragraph [355..379]
                Text(Borrowed("[")) [355..356]
                Text(Borrowed("!todo")) [356..361]
                Text(Borrowed("]")) [361..362]
                Text(Borrowed(" Yes!, they can.")) [362..378]
              BlockQuote { standard_kind: None, callout_metadata: Some(CalloutMetadata { kind: Obsidian(Example), title: Some("You can even use multiple layers of nesting."), foldable: None }) } [383..442]
                Paragraph [385..442]
