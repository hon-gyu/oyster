...
mod tests {
    ...
    fn callout() {
        ...
        Document [0..442]
          ...
          Callout { kind: GFM(Tip), title: None, foldable: None } [18..48]
            Paragraph [20..48]
              Text(Borrowed("[")) [20..21]
          ...
          Callout { kind: GFM(Tip), title: None, foldable: None } [50..80]
            Paragraph [51..80]
              Text(Borrowed("[")) [51..52]
          ...
          Callout { kind: GFM(Tip), title: Some("title"), foldable: None } [147..189]
            Paragraph [149..189]
          ...
          Callout { kind: GFM(Tip), title: Some("title"), foldable: None } [191..206]
            Paragraph [193..206]
          ...
          Callout { kind: GFM(Warning), title: None, foldable: None } [241..274]
            Paragraph [243..274]
          ...
          Callout { kind: Custom(Llm), title: None, foldable: None } [275..311]
            Paragraph [277..311]
          ...
          Callout { kind: Obsidian(Question), title: Some("Can callouts be nested?"), foldable: None } [313..442]
            Paragraph [315..351]
              Text(Borrowed("[")) [315..316]
              Text(Borrowed("!question")) [316..325]
              Text(Borrowed("]")) [325..326]
              Text(Borrowed(" Can callouts be nested?")) [326..350]
            Callout { kind: Obsidian(Todo), title: Some("Yes!, they can."), foldable: None } [353..442]
              Paragraph [355..379]
                Text(Borrowed("[")) [355..356]
                Text(Borrowed("!todo")) [356..361]
                Text(Borrowed("]")) [361..362]
                Text(Borrowed(" Yes!, they can.")) [362..378]
              Callout { kind: Obsidian(Example), title: Some("You can even use multiple layers of nesting."), foldable: None } [383..442]
                Paragraph [385..442]
